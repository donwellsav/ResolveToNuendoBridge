...
- Importer is now a real intake-analysis boundary (folder scan + lightweight parsers + canonical hydration).
- Exporter remains stub/planning-only (no Nuendo writing yet).
