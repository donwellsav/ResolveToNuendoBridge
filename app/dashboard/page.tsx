...
export default async function DashboardPage() {
  ...
  const unresolvedMappings = translationJobs.reduce((sum, job) => sum + summarizeUnresolved(job.mappingWorkspace).totalUnresolved, 0);
  ...
  return (
    <AppShell title="Dashboard">
      <div className="grid grid-cols-5 gap-4">
        ...
        <Card><CardHeader><CardTitle>Unresolved Mappings</CardTitle></CardHeader><CardContent><p className="text-2xl font-semibold text-warning">{unresolvedMappings}</p></CardContent></Card>
